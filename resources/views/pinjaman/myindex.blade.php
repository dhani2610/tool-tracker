            ...
            <tbody>
              ...
              @foreach ($peminjaman as $item)
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('lokasi_penggunaan') is-invalid @enderror" id="lokasi_penggunaan" name="lokasi_penggunaan" value="{{ $item->lokasi_penggunaan }}"  placeholder="Enter " readonly>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="time" class="form-control @error('jam_diterima') is-invalid @enderror jam_diterima" id="jam_diterima" name="jam_diterima" value="{{ $item->jam_diterima }}"  placeholder="Enter " readonly>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" class="form-control @error('tanggal_mulai') is-invalid @enderror tanggal_mulai" id="tanggal_mulai" name="tanggal_mulai" value="{{ $item->tanggal_mulai }}"  placeholder="Enter " readonly>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" class="form-control @error('tanggal_selesai') is-invalid @enderror tanggal_selesai" id="tanggal_selesai" name="tanggal_selesai" value="{{ $item->tanggal_selesai }}"  placeholder="Enter " readonly>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('keterangan') is-invalid @enderror keterangan" id="keterangan" name="keterangan" value="{{ $item->keterangan }}"  placeholder="Lengkap / Tidak " readonly>
                ...
                <td>
                  ...
                  <td>
                    <div class="btn-group">
                      <a href="{{ route('setuju-request-peminjaman-my-alat', $item->id_pinjaman) }}" class="btn btn-warning text-white">
                        Setuju
                      </a>
                      <a href="{{ route('tidak-setuju-request-peminjaman-my-alat', $item->id_pinjaman) }}" class="btn btn-danger f-12">
                        Tidak Setuju
                      </a>
                    </div>
                  </td>
